...
const whiteList = ['/login', '/auth-redirect', '/password/reset']; // no redirect whitelist
      ...
      if (hasRoles) {
        ...
        try {
          ...
          store.dispatch('permission/generateRoutes', { roles, permissions }).then(response => {
            ...
            console.log('route sau khi loc permission', response);
          ...
          // next(`/auth/students/login?redirect=${to.path}`);
